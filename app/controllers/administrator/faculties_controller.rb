class Administrator::FacultiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @faculty.save
        format.html { redirect_to ([:administrator, @faculty]), notice: 'Faculty was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @faculty.update_attributes(params[:faculty])
        format.html { redirect_to ([:administrator, @faculty]), notice: 'Faculty was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to administrator_faculties_url }
      format.json { head :no_content }
    end
  end
