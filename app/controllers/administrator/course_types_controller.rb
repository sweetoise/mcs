class Administrator::CourseTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @course_type.save
        format.html { redirect_to ([:administrator, @course_type]), notice: 'Course type was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @course_type.update_attributes(params[:course_type])
        format.html { redirect_to ([:administrator, @course_type]), notice: 'Course type was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to administrator_course_types_url }
      format.json { head :no_content }
    end
  end
