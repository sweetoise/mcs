...
class LevelsControllerTest < ActionController::TestCase
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post :create, level: { department_id: @level.department_id, faculty_id: @level.faculty_id, institution_id: @level.institution_id, level: @level.level }
    end
  ...
  test "should update level" do
    put :update, id: @level, level: { department_id: @level.department_id, faculty_id: @level.faculty_id, institution_id: @level.institution_id, level: @level.level }
    assert_redirected_to level_path(assigns(:level))
  end
